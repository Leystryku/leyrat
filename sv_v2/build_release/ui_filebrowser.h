...
public:
    ...
    void setupUi(QDialog *Filebrowser)
    {
        ...
        pushButton_2->setGeometry(QRect(380, 60, 101, 23));
        ...
        pushButton_4->setGeometry(QRect(380, 90, 101, 21));
    ...
    void retranslateUi(QDialog *Filebrowser)
    {
        ...
        label_2->setText(QApplication::translate("Filebrowser", "UDP Transfer", 0));
